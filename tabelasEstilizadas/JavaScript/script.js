function calcularMedia(n1Id, n2Id, n3Id, mediaId, statusId, linhaId) { // cria a funcao chamada calcular Media
...
if (media <4){
    ...
    document.getElementById(statusId).style.backgroundColor = "grey";
    document.getElementById(statusId).style.fontSize = "15px";  
} else{
    document.getElementById(statusId).innerText = "Aprovado!";
    document.getElementById(statusId).style.border = "6px solid green"; 
